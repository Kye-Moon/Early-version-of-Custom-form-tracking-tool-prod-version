		...
		<div className={'overflow-auto'}>
			...
			<PageContentSection>
				...
				<div className=" grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
					...
					<div className="sm:col-span-2">
						<StackedLabelAndValue label={'Customer Name'}
											  value={data?.project.customer}/>
					</div>
					<div className="sm:col-span-2 ">
			...
			<PageContentSection>
				<div className={'grid grid-cols-1 xl:grid-cols-2'}>
					<div className={'col-span-2 '}>
						...
						<JobSearchProvider defaultProjectId={params.projectId}>
							<JobSearch hideProjectSelect={true}/>
							<JobsTable/>
						</JobSearchProvider>
					</div>
				</div>
