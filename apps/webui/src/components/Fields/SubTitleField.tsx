...
import {
	SubTitleCustomInstance,
	SubTitleExtraAttributes,
	SubTitlePropertiesFormSchemaType, SubTitlePropertiesSchema
} from "form-types/SubTitleField";
...
export const SubTitleFieldFormElement: FormElement = {
	...
	construct: (id: string) => ({
		id,
		type,
		extraAttributes: SubTitleExtraAttributes
	}),
	designerBtnElement: {
		icon: LuHeading2,
