...
import {
	NumberCustomInstance,
	numberExtraAttributes, numberPropertiesFormSchemaType,
	numberPropertiesSchema
} from "form-types/NumberField";
...
export const NumberFieldFormElement: FormElement = {
  ...
  construct: (id: string) => ({
    id,
    type,
    extraAttributes:numberExtraAttributes
  }),
  designerBtnElement: {
    icon: Bs123,
    label: "Number Field",
...
function PropertiesComponent({ elementInstance }: { elementInstance: FormElementInstance }) {
  ...
  const form = useForm<numberPropertiesFormSchemaType>({
  ...
  function applyChanges(values: numberPropertiesFormSchemaType) {
