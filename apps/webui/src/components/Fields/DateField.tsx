...
import {
	DateCustomInstance,
	dateExtraAttributes,
	datePropertiesFormSchemaType, datePropertiesSchema
} from "form-types/DateField";
...
export const DateFieldFormElement: FormElement = {
	...
	construct: (id: string) => ({
		id,
		type,
		extraAttributes: dateExtraAttributes
	}),
	designerBtnElement: {
...
function PropertiesComponent({elementInstance}: { elementInstance: FormElementInstance }) {
	...
	const form = useForm<datePropertiesFormSchemaType>({
	...
	function applyChanges(values: datePropertiesFormSchemaType) {
